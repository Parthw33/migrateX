...
import type { ScrapingLog, CrawlProgress } from '~/components/chat/types';
...
export const ScrapingLogsDisplay: React.FC<ScrapingLogsProps> = ({
  logs,
  isComplete,
  hasError,
  websiteUrl,
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-purple-200">
                <div className="i-ph:globe-duotone text-white text-2xl" />
              </div>
            ...
            <div className="mt-6 pt-5 border-t border-gray-100">
              {hasError ? (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-600">Crawl Complete</p>
                    <p className="text-xs text-gray-500 mt-0.5">
                      {progress ? `${progress.current} of ${progress.total} pages processed` : 'All pages processed'}
                    </p>
                  </div>
                </div>
              ) : (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className="i-svg-spinners:90-ring-with-bg text-purple-600" />
                  ...
                  {progress?.status === 'scraping' && (
                    <p className="text-xs text-gray-400 mt-2 truncate">Currently processing: {progress.url}</p>
                  )}
                </div>
              )}
            </div>
            ...
            <div className="h-full overflow-y-auto">
              {logs.length > 0 ? (
                  ...
                  {logs.map((log) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={classNames('text-sm flex-1', styles.textClass)}>{log.message}</span>
                      </div>
                    );
                  })}
                  <div ref={logsEndRef} />
                ...
                <div className="flex flex-col items-center justify-center h-full py-12 text-gray-400">
                  ...
                  <p className="text-xs text-gray-400 mt-1">Logs will appear here as the crawler runs</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="bg-white border-t border-gray-200 px-6 py-4">
          <div className="max-w-4xl mx-auto flex justify-end">
            <StepActionButtons
              ...
              onNext={onContinue}
              onPrevious={onPrevious}
              reRunLabel="Re-Run Crawl"
              nextLabel="Continue to Content Types"
              show
              variant="footer"
            />
          </div>
